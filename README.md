# Battery health and RUL

> Battery state-of-health and remaining-useful-life modeling with interpretable uncertainty estimates.
...
Problem families relevant to **Tesla, ABB, Siemens** include efficient infrastructure, energy transition, intelligent assets, scientific discovery, and reliable decision support. This repository is independent and does not claim affiliation, endorsement, or use of proprietary company data.
